...
/* @var $model \core\forms\manager\Website\UpdateForm */
/* @var $website \core\entities\Customer\Website\Website */

$this->title = 'Update Website: ' . $website->name;
$this->params['breadcrumbs'][] = ['label' => 'Websites', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $website->name, 'url' => ['view', 'id' => $website->id]];
$this->params['breadcrumbs'][] = 'Update';

?>
<div class="website-update">
    <div class="website-form">
        <?php $form = ActiveForm::begin(['options' => ['data-id' => $website->id]]) ?>
            <div class="row">
                <div class="col-lg-9">
                    <div class="box box-primary">
                        <div class="box-body">
                                ...
                                'pluginOptions' => [
                                    ...
                                    'ajax' => [
                                        ...
                                        'data' => new JsExpression('function(params) { 
                                            return {q:params.term, id:$("#w0").data("id")}; 
                                        }')
                                    ],
                            ...
                            <?= $form->field($model, 'whiteListedDomains')->widget(Select2::class, [
                                'data' => $model->whiteListedDomainsList,
                                'options' => ['multiple' => true, 'placeholder' => 'Type domain...'],
                                'pluginOptions' => [
                                    'allowClear' => true,
                                    'minimumInputLength' => 3,
                    ...
                    <div class="box box-warning">
                        <div class="box-body">
                            <?= $form->field($model, 'customerId')->widget(Select2::class, [
                                'data' => [$model->customerId => $model->customerName],
