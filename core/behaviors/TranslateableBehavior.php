...
/**
 * Class TranslateableBehavior
 * @package core\behaviors
 * @property ActiveRecord $_models
 */
class TranslateableBehavior extends Behavior
{
    ...
    public function saveTranslation()
    {
        ...
        foreach ($this->_models as $language => $model) {
            ...
            if ($this->skipSavingDuplicateTranslation && $model->isNewRecord && $this->modelEqualsFallbackTranslation($model, $language)) {
                continue;
            }
